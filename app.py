...
#     model.load_state_dict(torch.load(r'E:\Image Segmentation\saved_model\best_model.pt', map_location=DEVICE))
#     model.to(DEVICE)
#     model.eval()
#     return model
...
#         st.image(Image.fromarray(resized_image), use_column_width=True)
#     with col2:
#         st.subheader("Predicted Mask")
#         st.image(pred_mask * 255, use_column_width=True, clamp=True)  # Scale to 0-255 for display as grayscale
